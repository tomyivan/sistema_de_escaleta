      ...
      $.fn.Tabledit = function(options) {
                      ...
                      for (var i = 0; i < settings.columns.editable.length; i++) {
                          ...
                          $td.each(function() {
                              ...
                              if (typeof settings.columns.editable[i][2] !== 'undefined') {
                                  ...
                                  var input = '<select class="tabledit-input ' + settings.inputClass + '" name="' + settings.columns.editable[i][1] + '" style="display: none; width: 100px;font-size:14px" disabled>';
                                  ...
                                  if(settings.columns.editable[i][1] == 'emitido' || settings.columns.editable[i][1] == 'bloque'){
                                    var input = '<input class="tabledit-input ' + settings.inputClass + ' ' + settings.columns.editable[i][1] + '" type="text" name="' + settings.columns.editable[i][1] + '"  value="' + $(this).text() + '" style="display: none; width: 50px; font-size:14px" disabled >';
                                  }else if(settings.columns.editable[i][1] == 'duracion'){
                                    var input = '<input class="tabledit-input ' + settings.inputClass + ' ' + settings.columns.editable[i][1] + '" type="time" step="1" name="' + settings.columns.editable[i][1] + '"  value="' + $(this).text() + '" style="display: none; width: 120px; font-size:14px" disabled >';

                                  } 
                                  else{
                                    var input = '<input class="tabledit-input ' + settings.inputClass + ' ' + settings.columns.editable[i][1] + '" type="text" name="' + settings.columns.editable[i][1] + '"  value="' + $(this).text() + '" style="display: none; width: 100px; font-size:14px" disabled >';
                                  }
                              }
          ...
          var Edit = {
              ...
              submit: function(td) {
                  ...
                  $(td).each(function() {
                      // Get input element.
                      var $input = $(this).find('.tabledit-input:nth-child(2)');
